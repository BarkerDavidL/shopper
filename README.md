...
Welcome to the Shopper Crew project, powered by [crewAI](https://crewai.com). This template is designed to help you set up a multi-agent AI system with ease, leveraging the powerful and flexible framework provided by crewAI. Our goal is to enable your agents to collaborate effectively on complex tasks, maximizing their collective intelligence and capabilities.
...
- Modify `src/shopper/config/agents.yaml` to define your agents
- Modify `src/shopper/config/tasks.yaml` to define your tasks
- Modify `src/shopper/crew.py` to add your own logic, tools and specific args
- Modify `src/shopper/main.py` to add custom inputs for your agents and tasks
...
This command initializes the shopper Crew, assembling the agents and assigning them tasks as defined in your configuration.
...
For support, questions, or feedback regarding the Shopper Crew or crewAI.
